...
func BuildSnapshotChecked(productID string, g *domain.Graph) (Snapshot, error) {
	if err := Validate(g); err != nil {
		return Snapshot{}, fmt.Errorf("build dependency snapshot: %w", err)
	}
	return BuildSnapshot(productID, g), nil
}
